...
<body>
    <div class="container">
        ...
        <div class="content">
            <form action="viewbook.php" class="book-form" method = "post">
                <div class = "head">
                    <h1>Search Book</h1>
                    <p>Search Book from the database according to ISBN</p>
                    <hr>
                </div>
                ...
                <div class="book-container">
                    ...
                    <div class="form-element">
                        ...
                        <input type="text" placeholder="Enter ISBN of the book" name="search" id="search" maxlength=30 required>
                    </div>

                    <div class="form-element">
                        <button type="submit" class="submitbtn" name="submit">Search Book</button>
                    </div>
